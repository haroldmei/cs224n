...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder                    = nn.LSTM(embed_size, hidden_size, dropout=self.dropout_rate, bidirectional=True)   # Dropout ?
        self.decoder                    = nn.LSTMCell(embed_size + self.hidden_size, self.hidden_size)  # LSTM is an RNN, LSTMCell is only one step in the RNN. Can we change it to LSTM as well?
